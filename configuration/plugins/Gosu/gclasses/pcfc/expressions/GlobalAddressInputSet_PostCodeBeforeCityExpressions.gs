...
class GlobalAddressInputSet_PostCodeBeforeCityExpressions {
  ...
  public static class GlobalAddressInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'autoComplete' attribute on AddressAutoFillInput (id=City) at AddressAutoFillWidget.xml: line 8, column 92
    function autoComplete_108 () : gw.api.contact.AutocompleteHandler {
      return cityhandler
    }
    
    // 'autoComplete' attribute on AddressAutoFillInput (id=PostalCode) at AddressAutoFillWidget.xml: line 8, column 92
    function autoComplete_75 () : gw.api.contact.AutocompleteHandler {
      return pchandler
    }
    ...
    // 'value' attribute on AddressAutoFillInput (id=City) at AddressAutoFillWidget.xml: line 8, column 92
    ...
    function inputConversion_70 (VALUE :  java.lang.String) : java.lang.Object {
    ...
    function inputMask_76 () : java.lang.String {
    ...
    // 'required' attribute on AddressAutoFillInput (id=City) at AddressAutoFillWidget.xml: line 8, column 92
    ...
    function required_128 () : java.lang.Boolean {
    ...
    function required_139 () : java.lang.Boolean {
