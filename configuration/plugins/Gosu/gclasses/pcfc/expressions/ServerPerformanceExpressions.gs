...
class ServerPerformanceExpressions {
  ...
  public static class ServerPerformanceExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ServerPerformance.pcf: line 101, column 42
    function def_onEnter_19 (def :  pcf.ServerToolsDisclaimerDV) : void {
      def.onEnter()
    }
    
    // 'def' attribute on PanelRef at ServerPerformance.pcf: line 101, column 42
    function def_refreshVariables_20 (def :  pcf.ServerToolsDisclaimerDV) : void {
