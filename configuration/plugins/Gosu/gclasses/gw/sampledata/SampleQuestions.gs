  ...
  function testSampleData2(bundle: Bundle) {
    ...
    (\-> {
      ...
      var questionChoicesiugenquestion1yes = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Yes")
          .withPublicId("siugenquestion1yes")
          .withCode("Yes")
          .withScore(0)
          .onQuestion(questionsiugenquestion1)
          .withPriority(0)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Yes")
          .create(bundle)
      ...
      var questionChoicesiugenquestion1no = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.No")
          .withPublicId("siugenquestion1no")
          .withCode("No")
          .withScore(0)
          .onQuestion(questionsiugenquestion1)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.No")
          .create(bundle)
  ...
  function testSampleData3(bundle: Bundle) {
    ...
    (\-> {
      ...
      var questionChoicesiuq12below400 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Below400")
          .withPublicId("siuq12below400")
          .withCode("Below 400")
          .withScore(3)
          .onQuestion(questionsiugenquestion12)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Below400")
          .create(bundle)


      var questionChoicesiuq12400500 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Range400To500")
          .withPublicId("siuq12400500")
          .withCode("400-500")
          .withScore(2)
          .onQuestion(questionsiugenquestion12)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Range400To500")
          .create(bundle)


      var questionChoicesiuq12500600 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Range500To600")
          .withPublicId("siuq12500600")
          .withCode("500-600")
          .withScore(1)
          .onQuestion(questionsiugenquestion12)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Range500To600")
          .create(bundle)


      var questionChoicesiuq12600above = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Above600")
          .withPublicId("siuq12600above")
          .withCode("Above 600")
          .withScore(0)
          .onQuestion(questionsiugenquestion12)
          .withPriority(0)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Above600")
          .create(bundle)


      var questionChoicesiuq12notavail = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.NotAvailable")
          .withPublicId("siuq12notavail")
          .withCode("Not Available")
          .withScore(1)
          .onQuestion(questionsiugenquestion12)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.NotAvailable")
          .create(bundle)


      var questionChoicesiuq530DaysLess = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.30DaysOrLess")
          .withPublicId("siuq530DaysLess")
          .withCode("30 days or less")
          .withScore(1)
          .onQuestion(questionsiucarquestion5)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.30DaysOrLess")
          .create(bundle)


      var questionChoicesiuq53090days = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.30To90Days")
          .withPublicId("siuq53090days")
          .withCode("30-90 Days")
          .withScore(2)
          .onQuestion(questionsiucarquestion5)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.30To90Days")
          .create(bundle)


      var questionChoicesiu590moredays = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan90Days")
          .withPublicId("siu590moredays")
          .withCode("More than 90 Days")
          .withScore(3)
          .onQuestion(questionsiucarquestion5)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan90Days")
          .create(bundle)


      var questionChoicesiuq5unavalable = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Unavailable")
          .withPublicId("siuq5unavalable")
          .withCode("Unavailable")
          .withScore(1)
          .onQuestion(questionsiucarquestion5)
          .withPriority(4)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Unavailable")
          .create(bundle)
    })()
  }
  ...
  function testSampleData4(bundle: Bundle) {
    (\-> {
      var questionChoiceQuestionChoiceSPM1 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Within1DayOfInitialContact")
          .withPublicId("QuestionChoiceSPM:1")
          .withCode("win1day")
          .withScore(100)
          .onQuestion(questionQuestionSPM1)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Within1DayOfInitialContact")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM2 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Within3DaysOfInitialContact")
          .withPublicId("QuestionChoiceSPM:2")
          .withCode("win3day")
          .withScore(50)
          .onQuestion(questionQuestionSPM1)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Within3DaysOfInitialContact")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM3 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan3DaysFromInitialContact")
          .withPublicId("QuestionChoiceSPM:3")
          .withCode("more3days")
          .withScore(0)
          .onQuestion(questionQuestionSPM1)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan3DaysFromInitialContact")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM4 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.SameDay")
          .withPublicId("QuestionChoiceSPM:4")
          .withCode("sameday")
          .withScore(100)
          .onQuestion(questionQuestionSPM2)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.SameDay")
          .create(bundle)
      ...
      var questionChoiceQuestionChoiceSPM8 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.OnTime")
          .withPublicId("QuestionChoiceSPM:8")
          .withCode("ontime")
          .withScore(100)
          .onQuestion(questionQuestionSPM3)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.OnTime")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM9 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Within1DayOfEstimate")
          .withPublicId("QuestionChoiceSPM:9")
          .withCode("win1day")
          .withScore(70)
          .onQuestion(questionQuestionSPM3)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Within1DayOfEstimate")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM10 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Within3DaysOfEstimate")
          .withPublicId("QuestionChoiceSPM:10")
          .withCode("win3day")
          .withScore(50)
          .onQuestion(questionQuestionSPM3)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Within3DaysOfEstimate")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM11 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan3DaysPastEstimate")
          .withPublicId("QuestionChoiceSPM:11")
          .withCode("more3days")
          .withScore(0)
          .onQuestion(questionQuestionSPM3)
          .withPriority(4)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan3DaysPastEstimate")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM12 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Excellent")
          .withPublicId("QuestionChoiceSPM:12")
          .withCode("excellent")
          .withScore(100)
          .onQuestion(questionQuestionSPM4)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Excellent")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM13 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Satisfactory")
          .withPublicId("QuestionChoiceSPM:13")
          .withCode("satisfactory")
          .withScore(50)
          .onQuestion(questionQuestionSPM4)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Satisfactory")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM14 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Poor")
          .withPublicId("QuestionChoiceSPM:14")
          .withCode("poor")
          .withScore(0)
          .onQuestion(questionQuestionSPM4)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Poor")
          .create(bundle)
      ...
      var questionChoiceQuestionChoiceSPM19 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Great")
          .withPublicId("QuestionChoiceSPM:19")
          .withCode("great")
          .withScore(100)
          .onQuestion(questionQuestionSPM7)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Great")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM20 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Good")
          .withPublicId("QuestionChoiceSPM:20")
          .withCode("good")
          .withScore(70)
          .onQuestion(questionQuestionSPM7)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Good")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM21 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Ok")
          .withPublicId("QuestionChoiceSPM:21")
          .withCode("ok")
          .withScore(50)
          .onQuestion(questionQuestionSPM7)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Ok")
          .create(bundle)
      ...
      var questionChoiceQuestionChoiceSPM36 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.1")
          .withPublicId("QuestionChoiceSPM:36")
          .withCode("one")
          .withScore(25)
          .onQuestion(questionQuestionSPM12)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.1")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM37 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.2To3")
          .withPublicId("QuestionChoiceSPM:37")
          .withCode("twothree")
          .withScore(10)
          .onQuestion(questionQuestionSPM12)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.2To3")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM38 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan3")
          .withPublicId("QuestionChoiceSPM:38")
          .withCode("morethan3")
          .withScore(0)
          .onQuestion(questionQuestionSPM12)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.MoreThan3")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM39 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Within5PercentOfOriginalQuote")
          .withPublicId("QuestionChoiceSPM:39")
          .withCode("atmost5")
          .withScore(25)
          .onQuestion(questionQuestionSPM13)
          .withPriority(1)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Within5PercentOfOriginalQuote")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM40 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Between5And10Percent")
          .withPublicId("QuestionChoiceSPM:40")
          .withCode("fiveten")
          .withScore(10)
          .onQuestion(questionQuestionSPM13)
          .withPriority(2)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Between5And10Percent")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM41 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.Between10And20Percent")
          .withPublicId("QuestionChoiceSPM:41")
          .withCode("tentwenty")
          .withScore(5)
          .onQuestion(questionQuestionSPM13)
          .withPriority(3)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.Between10And20Percent")
          .create(bundle)


      var questionChoiceQuestionChoiceSPM42 = new gw.api.databuilder.QuestionChoiceBuilder()
          .withDescriptionByDisplayKey("Web.CCSampleData.QuestionChoice.GreaterThan20Percent")
          .withPublicId("QuestionChoiceSPM:42")
          .withCode("over20")
          .withScore(0)
          .onQuestion(questionQuestionSPM13)
          .withPriority(4)
          .withNameByDisplayKey("Web.CCSampleData.QuestionChoice.GreaterThan20Percent")
          .create(bundle)
    })()
    ...
    (\-> {
      ...
      var reviewTypeSPMReviewType1 = new gw.api.databuilder.ReviewTypeBuilder()
          ...
          .withDescription(DisplayKey.get("Web.CCSampleData.ReviewType.AutoRepairShop.Desc"))
          .withContactSubtype(TC_AUTOREPAIRSHOP)
          .withName(DisplayKey.get("Web.CCSampleData.ReviewType.AutoRepairShop.Name"))
          .create(bundle)
