...
public class BatchProcessType implements gw.entity.TypeKey {
  ...
  /**
   * Claim Timeline Creation
   * Creates and adds timeline entries to the Claim Timeline
   */
  public static final typekey.BatchProcessType TC_CLAIMTIMELINECREATION = new typekey.BatchProcessType("ClaimTimelineCreation");
