...
public class InjuryIncident extends entity.Incident {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> INJURYPOINTS_EXT_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "InjuryPoints_Ext");
  ...
  /**
   * Adds the given element to the InjuryPoints_Ext array. This is achieved by setting the parent foreign key to this entity instance.
   */
  public void addToInjuryPoints_Ext(entity.BodilyInjuryPoint_Ext element) {
    __getInternalInterface().addArrayElement(INJURYPOINTS_EXT_PROP.get(), element);
  }
  ...
  /**
   * Gets the value of the InjuryPoints_Ext field.
   * Array of the Injury Points on the person
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.BodilyInjuryPoint_Ext[] getInjuryPoints_Ext() {
    return (entity.BodilyInjuryPoint_Ext[])__getInternalInterface().getFieldValue(INJURYPOINTS_EXT_PROP.get());
  }
  ...
  /**
   * Removes the given element from the InjuryPoints_Ext array. This is achieved by marking the element for removal.
   */
  public void removeFromInjuryPoints_Ext(entity.BodilyInjuryPoint_Ext element) {
    __getInternalInterface().removeArrayElement(INJURYPOINTS_EXT_PROP.get(), element);
  }
   ...
   */
  @java.lang.Deprecated
  public void removeFromInjuryPoints_Ext(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(INJURYPOINTS_EXT_PROP.get(), elementID);
  }
  ...
  /**
   * Sets the value of the InjuryPoints_Ext field.
   */
  public void setInjuryPoints_Ext(entity.BodilyInjuryPoint_Ext[] value) {
    __getInternalInterface().setFieldValue(INJURYPOINTS_EXT_PROP.get(), value);
  }
