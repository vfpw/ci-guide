...
/**
 * TimeCreationWorkItem_Ext
 * A custom work item for the timeline creation work queue
 */
...
@gw.entity.EntityName(value = "TimeCreationWorkItem_Ext")
public class TimeCreationWorkItem_Ext extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean, entity.WorkItem {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TimeCreationWorkItem_Ext> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TimeCreationWorkItem_Ext>("entity.TimeCreationWorkItem_Ext");
  ...
  private com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternal _internal;
   ...
   */
  public TimeCreationWorkItem_Ext()  {
   ...
   */
  public TimeCreationWorkItem_Ext(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TimeCreationWorkItem_Ext(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TimeCreationWorkItem_Ext.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TimeCreationWorkItem_Ext.class, config);
    com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TimeCreationWorkItem_Ext, com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternal>() {
      public java.lang.Object getImplementation(entity.TimeCreationWorkItem_Ext bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TimeCreationWorkItem_ExtInternal getInternalInterface(entity.TimeCreationWorkItem_Ext bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TimeCreationWorkItem_Ext newEmptyInstance() {
        return new entity.TimeCreationWorkItem_Ext((java.lang.Void)null);
      }
