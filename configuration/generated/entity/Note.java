...
public class Note extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.EventAware, com.guidewire.cc.domain.relatedto.RelatedToBean {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PORTALAUTHORREALM_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PortalAuthorRealm_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PORTALAUTHORUSERNAME_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PortalAuthorUsername_Ext");
  ...
  /**
   * Gets the value of the PortalAuthorRealm_Ext field.
   * The security realm of the portal user which created the note. A realm identifies a collection of users and groups.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getPortalAuthorRealm_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PORTALAUTHORREALM_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the PortalAuthorUsername_Ext field.
   * The username of the portal user which created the note
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getPortalAuthorUsername_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PORTALAUTHORUSERNAME_EXT_PROP.get());
  }
  ...
  /**
   * Sets the value of the PortalAuthorRealm_Ext field.
   */
  public void setPortalAuthorRealm_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PORTALAUTHORREALM_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the PortalAuthorUsername_Ext field.
   */
  public void setPortalAuthorUsername_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PORTALAUTHORUSERNAME_EXT_PROP.get(), value);
  }
