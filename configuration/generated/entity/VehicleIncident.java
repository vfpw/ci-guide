...
public class VehicleIncident extends entity.MobilePropertyIncident {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> DAMAGEPOINTS_EXT_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "DamagePoints_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> REPAIROPTION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RepairOption");
  ...
  /**
   * Adds the given element to the DamagePoints_Ext array. This is achieved by setting the parent foreign key to this entity instance.
   */
  public void addToDamagePoints_Ext(entity.VehicleDamagePoint_Ext element) {
    __getInternalInterface().addArrayElement(DAMAGEPOINTS_EXT_PROP.get(), element);
  }
  ...
  /**
   * Gets the value of the DamagePoints_Ext field.
   * Array of the Damage Points on the vehicle
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.VehicleDamagePoint_Ext[] getDamagePoints_Ext() {
    return (entity.VehicleDamagePoint_Ext[])__getInternalInterface().getFieldValue(DAMAGEPOINTS_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the RepairOption field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.RepairOption_Ext getRepairOption() {
    return (entity.RepairOption_Ext)__getInternalInterface().getFieldValue(REPAIROPTION_PROP.get());
  }
  ...
  /**
   * Removes the given element from the DamagePoints_Ext array. This is achieved by marking the element for removal.
   */
  public void removeFromDamagePoints_Ext(entity.VehicleDamagePoint_Ext element) {
    __getInternalInterface().removeArrayElement(DAMAGEPOINTS_EXT_PROP.get(), element);
  }
   ...
   */
  @java.lang.Deprecated
  public void removeFromDamagePoints_Ext(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(DAMAGEPOINTS_EXT_PROP.get(), elementID);
  }
  ...
  /**
   * Sets the value of the DamagePoints_Ext field.
   */
  public void setDamagePoints_Ext(entity.VehicleDamagePoint_Ext[] value) {
    __getInternalInterface().setFieldValue(DAMAGEPOINTS_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the RepairOption field.
   */
  public void setRepairOption(entity.RepairOption_Ext value) {
    __getInternalInterface().setFieldValue(REPAIROPTION_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.VehicleIncidentInternal {
    ...
    public gw.pl.persistence.core.Key getRepairOptionID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(REPAIROPTION_PROP.get());
    }
    ...
    public void setRepairOptionID(gw.pl.persistence.core.Key value) {
      setFieldValue(REPAIROPTION_PROP.get(), value);
    }
