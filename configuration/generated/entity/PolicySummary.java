...
public class PolicySummary extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PRODUCERCODECODE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ProducerCodeCode");
  ...
  /**
   * Gets the value of the ProducerCodeCode field.
   * Code of the Agency that sold the policy
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getProducerCodeCode() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PRODUCERCODECODE_PROP.get());
  }
  ...
  /**
   * Sets the value of the ProducerCodeCode field.
   */
  public void setProducerCodeCode(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PRODUCERCODECODE_PROP.get(), value);
  }
