...
public class Claim extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Validatable, entity.Extractable, entity.CCAssignable, entity.WorkloadDelegate, entity.DestructionRootPinnable, entity.ISOReportable, entity.UserRoleOwner, entity.ClaimContactRoleOwner, entity.EventAware, com.guidewire.cc.domain.email.CCEmailSupport, com.guidewire.cc.domain.purging.Purgeable, gw.api.assignment.CCAssignableMethods, gw.api.assignment.UserRoleOwner, gw.api.heatmap.CatastropheMethods, gw.api.metric.ClaimUpdateMetricsMethods, gw.api.question.AnswerSetContainer, gw.api.specialhandling.ClaimSpecialHandlingMethods {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> ACCIDENTDIAGRAMDATAPEL_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "AccidentDiagramDataPEL");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INSUREDVEHICLECOLOR_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "InsuredVehicleColor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> TIMELINE_EXT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Timeline_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> TIMELINE_EXTARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Timeline_ExtArray");
  ...
  /**
   * Gets the value of the AccidentDiagramDataPEL field.
   * Accident diagram selected for this claim
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.AccidentDiagramDataPEL getAccidentDiagramDataPEL() {
    return (entity.AccidentDiagramDataPEL)__getInternalInterface().getFieldValue(ACCIDENTDIAGRAMDATAPEL_PROP.get());
  }
  ...
  /**
   * Gets the value of the InsuredVehicleColor field.
   * Color of the insured's vehicle from the accident scenario
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.AccidentScenarioInsVehPEL getInsuredVehicleColor() {
    return (typekey.AccidentScenarioInsVehPEL)__getInternalInterface().getFieldValue(INSUREDVEHICLECOLOR_PROP.get());
  }
  ...
  /**
   * Gets the value of the Timeline_Ext field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Timeline_Ext getTimeline_Ext() {
    return (entity.Timeline_Ext)__getInternalInterface().getFieldValue(TIMELINE_EXT_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Timeline_Ext[] getTimeline_ExtArray() {
    return (entity.Timeline_Ext[])__getInternalInterface().getFieldValue(TIMELINE_EXTARRAY_PROP.get());
  }
  ...
  /**
   * Sets the value of the AccidentDiagramDataPEL field.
   */
  public void setAccidentDiagramDataPEL(entity.AccidentDiagramDataPEL value) {
    __getInternalInterface().setFieldValue(ACCIDENTDIAGRAMDATAPEL_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the InsuredVehicleColor field.
   */
  public void setInsuredVehicleColor(typekey.AccidentScenarioInsVehPEL value) {
    __getInternalInterface().setFieldValue(INSUREDVEHICLECOLOR_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the Timeline_Ext field.
   */
  public void setTimeline_Ext(entity.Timeline_Ext value) {
    __getInternalInterface().setFieldValue(TIMELINE_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Timeline_ExtArray field.
   */
  private void setTimeline_ExtArray(entity.Timeline_Ext[] value) {
    __getInternalInterface().setFieldValue(TIMELINE_EXTARRAY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimInternal {
    ...
    /**
     * Adds the given element to the Timeline_ExtArray array. This is achieved by setting the parent foreign key to this entity instance.
     */
    public void addToTimeline_ExtArray(entity.Timeline_Ext element) {
      __getInternalInterface().addArrayElement(TIMELINE_EXTARRAY_PROP.get(), element);
    }
    ...
    public gw.pl.persistence.core.Key getAccidentDiagramDataPELID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(ACCIDENTDIAGRAMDATAPEL_PROP.get());
    }
    ...
    /**
     * Gets the value of the Timeline_ExtArray field.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.Timeline_Ext[] getTimeline_ExtArray() {
      return (entity.Timeline_Ext[])__getInternalInterface().getFieldValue(TIMELINE_EXTARRAY_PROP.get());
    ...
    public gw.pl.persistence.core.Key getTimeline_ExtID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(TIMELINE_EXT_PROP.get());
    }
    ...
    /**
     * Removes the given element from the Timeline_ExtArray array. This is achieved by marking the element for removal.
     */
    public void removeFromTimeline_ExtArray(entity.Timeline_Ext element) {
      __getInternalInterface().removeArrayElement(TIMELINE_EXTARRAY_PROP.get(), element);
    }
     ...
     */
    @java.lang.Deprecated
    public void removeFromTimeline_ExtArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(TIMELINE_EXTARRAY_PROP.get(), elementID);
    }
    ...
    public void setAccidentDiagramDataPELID(gw.pl.persistence.core.Key value) {
      setFieldValue(ACCIDENTDIAGRAMDATAPEL_PROP.get(), value);
    }
     ...
     * Sets the value of the Timeline_ExtArray field.
     */
    public void setTimeline_ExtArray(entity.Timeline_Ext[] value) {
      __getInternalInterface().setFieldValue(TIMELINE_EXTARRAY_PROP.get(), value);
    }
    
    public void setTimeline_ExtID(gw.pl.persistence.core.Key value) {
      setFieldValue(TIMELINE_EXT_PROP.get(), value);
    }
