...
public class Payment extends entity.Transaction implements entity.EventAware, gw.api.financials.PaymentMethods, gw.api.financials.PaymentTransferMethods {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PaymentInternal {
    ...
    /**
     * Adds the given element to the OriginTransactionOnset_ExtArray array. This is achieved by setting the parent foreign key to this entity instance.
     */
    public void addToOriginTransactionOnset_ExtArray(entity.TransactionOnset element) {
      __getInternalInterface().addArrayElement(ORIGINTRANSACTIONONSET_EXTARRAY_PROP.get(), element);
    }
    ...
    /**
     * Gets the value of the OriginTransactionOnset_Ext field.
     * TransactionOnset join entity pointing to this Transaction as an onset
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.TransactionOnset getOriginTransactionOnset_Ext() {
      return (entity.TransactionOnset)__getInternalInterface().getFieldValue(ORIGINTRANSACTIONONSET_EXT_PROP.get());
    }
    
    /**
     * Gets the value of the OriginTransactionOnset_ExtArray field.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.TransactionOnset[] getOriginTransactionOnset_ExtArray() {
      return (entity.TransactionOnset[])__getInternalInterface().getFieldValue(ORIGINTRANSACTIONONSET_EXTARRAY_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getOriginTransactionOnset_ExtID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(ORIGINTRANSACTIONONSET_EXT_PROP.get());
    }
    ...
    /**
     * Removes the given element from the OriginTransactionOnset_ExtArray array. This is achieved by marking the element for removal.
     */
    public void removeFromOriginTransactionOnset_ExtArray(entity.TransactionOnset element) {
      __getInternalInterface().removeArrayElement(ORIGINTRANSACTIONONSET_EXTARRAY_PROP.get(), element);
    }
     ...
     */
    @java.lang.Deprecated
    public void removeFromOriginTransactionOnset_ExtArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(ORIGINTRANSACTIONONSET_EXTARRAY_PROP.get(), elementID);
    }
    ...
    /**
     * Sets the value of the OriginTransactionOnset_Ext field.
     */
    public void setOriginTransactionOnset_Ext(entity.TransactionOnset value) {
      __getInternalInterface().setFieldValue(ORIGINTRANSACTIONONSET_EXT_PROP.get(), value);
    }
    
    /**
     * Sets the value of the OriginTransactionOnset_ExtArray field.
     */
    public void setOriginTransactionOnset_ExtArray(entity.TransactionOnset[] value) {
      __getInternalInterface().setFieldValue(ORIGINTRANSACTIONONSET_EXTARRAY_PROP.get(), value);
    }
    
    public void setOriginTransactionOnset_ExtID(gw.pl.persistence.core.Key value) {
      setFieldValue(ORIGINTRANSACTIONONSET_EXT_PROP.get(), value);
    }
