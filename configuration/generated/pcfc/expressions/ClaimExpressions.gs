...
class ClaimExpressions {
  ...
  public static class ClaimExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function browserTitle_111 () : java.lang.String {
      return DisplayKey.get("Web.Claim.WindowTitle", Claim.ClaimNumber)
    }
    
    // LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    static function firstVisitableChildDestinationMethod_120 (Claim :  Claim) : pcf.api.Destination {
    ...
    function infoBar_onEnter_112 (def :  pcf.ClaimInfoBar) : void {
      def.onEnter(Claim)
    }
    
    // 'infoBar' attribute on LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    function infoBar_refreshVariables_113 (def :  pcf.ClaimInfoBar) : void {
    ...
    function menuActions_onEnter_114 (def :  pcf.ClaimMenuActions) : void {
      def.onEnter(Claim)
    }
    
    // 'menuActions' attribute on LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    function menuActions_refreshVariables_115 (def :  pcf.ClaimMenuActions) : void {
      def.refreshVariables(Claim)
    }
    
    // 'parent' attribute on LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    static function parent_116 (Claim :  Claim) : pcf.api.Destination {
      return pcf.ClaimForward.createDestination(Claim)
    }
    
    // 'tabBar' attribute on LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    function tabBar_onEnter_117 (def :  pcf.TabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    function tabBar_refreshVariables_118 (def :  pcf.TabBar) : void {
      def.refreshVariables()
    }
    
    // 'title' attribute on LocationGroup (id=Claim) at Claim.pcf: line 12, column 94
    static function title_119 (Claim :  Claim) : java.lang.Object {
